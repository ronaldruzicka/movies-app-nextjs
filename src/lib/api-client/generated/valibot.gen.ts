...
export const vMovieDetailsResponse = v.object({
    ...
    popularity: v.optional(v.number(), 0),
    poster_path: v.optional(v.string()),
    production_companies: v.optional(v.array(v.object({
        id: v.optional(v.pipe(v.number(), v.integer()), 0),
        logo_path: v.optional(v.string()),
        name: v.optional(v.string()),
        origin_country: v.optional(v.string())
    }))),
    production_countries: v.optional(v.array(v.object({
    ...
    spoken_languages: v.optional(v.array(v.object({
...
export const vTvSeriesDetailsResponse = v.object({
    adult: v.optional(v.boolean(), true),
    backdrop_path: v.optional(v.string()),
    created_by: v.optional(v.array(v.object({
        id: v.optional(v.pipe(v.number(), v.integer()), 0),
    ...
    last_episode_to_air: v.optional(v.object({
        id: v.optional(v.pipe(v.number(), v.integer()), 0),
        name: v.optional(v.string()),
        overview: v.optional(v.string()),
        vote_average: v.optional(v.number(), 0),
...
export const vSearchPersonResponse = v.object({
    ...
    results: v.optional(v.array(v.object({
        ...
        popularity: v.optional(v.number(), 0),
        profile_path: v.optional(v.string()),
        known_for: v.optional(v.array(v.object({
            adult: v.optional(v.boolean(), true),
            backdrop_path: v.optional(v.string()),
            id: v.optional(v.pipe(v.number(), v.integer()), 0),
            title: v.optional(v.string()),
...
export const vTvSeasonDetailsResponse = v.object({
    ...
    episodes: v.optional(v.array(v.object({
        ...
        guest_stars: v.optional(v.array(v.object({
...
export const vMovieImagesResponse = v.object({
    backdrops: v.optional(v.array(v.object({
    ...
    posters: v.optional(v.array(v.object({
        aspect_ratio: v.optional(v.number(), 0),
        height: v.optional(v.pipe(v.number(), v.integer()), 0),
        iso_639_1: v.optional(v.string()),
        file_path: v.optional(v.string()),
...
export const vTvEpisodeImagesResponse = v.object({
    id: v.optional(v.pipe(v.number(), v.integer()), 0),
    stills: v.optional(v.array(v.object({
        aspect_ratio: v.optional(v.number(), 0),
        height: v.optional(v.pipe(v.number(), v.integer()), 0),
        iso_639_1: v.optional(v.unknown()),
        file_path: v.optional(v.string()),
...
export const vMovieAlternativeTitlesResponse = v.object({
    id: v.optional(v.pipe(v.number(), v.integer()), 0),
    titles: v.optional(v.array(v.object({
        iso_3166_1: v.optional(v.string()),
        title: v.optional(v.string()),
        type: v.optional(v.string())
    })))
...
export const vMovieKeywordsResponse = v.object({
    id: v.optional(v.pipe(v.number(), v.integer()), 0),
    keywords: v.optional(v.array(v.object({
        id: v.optional(v.pipe(v.number(), v.integer()), 0),
        name: v.optional(v.string())
    })))
});
...
export const vMovieReleaseDatesResponse = v.object({
    ...
    results: v.optional(v.array(v.object({
        iso_3166_1: v.optional(v.string()),
        release_dates: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
...
export const vMovieReviewsResponse = v.object({
    ...
    results: v.optional(v.array(v.object({
        ...
        author_details: v.optional(v.object({
            name: v.optional(v.string()),
...
export const vMovieWatchProvidersResponse = v.object({
    ...
    results: v.optional(v.object({
        AE: v.optional(v.object({
            link: v.optional(v.string()),
            flatrate: v.optional(v.array(v.object({
                logo_path: v.optional(v.string()),
            ...
            rent: v.optional(v.array(v.object({
                logo_path: v.optional(v.string()),
                provider_id: v.optional(v.pipe(v.number(), v.integer()), 0),
                provider_name: v.optional(v.string()),
                display_priority: v.optional(v.pipe(v.number(), v.integer()), 0)
            }))),
            buy: v.optional(v.array(v.object({
                logo_path: v.optional(v.string()),
                provider_id: v.optional(v.pipe(v.number(), v.integer()), 0),
                provider_name: v.optional(v.string()),
                display_priority: v.optional(v.pipe(v.number(), v.integer()), 0)
...
export const vFindByIdResponse = v.object({
    movie_results: v.optional(v.array(v.object({
        adult: v.optional(v.boolean(), true),
        backdrop_path: v.optional(v.string()),
        id: v.optional(v.pipe(v.number(), v.integer()), 0),
        title: v.optional(v.string()),
...
export const vTvSeriesChangesResponse = v.object({
    changes: v.optional(v.array(v.object({
        ...
        items: v.optional(v.array(v.object({
            ...
            original_value: v.optional(v.object({
                poster: v.optional(v.object({
                    file_path: v.optional(v.string()),
                    iso_639_1: v.optional(v.string())
                }))
...
export const vTvSeriesWatchProvidersResponse = v.object({
    ...
    results: v.optional(v.object({
        ...
        US: v.optional(v.object({
            link: v.optional(v.string()),
            free: v.optional(v.array(v.object({
                logo_path: v.optional(v.string()),
                provider_id: v.optional(v.pipe(v.number(), v.integer()), 0),
                provider_name: v.optional(v.string()),
                display_priority: v.optional(v.pipe(v.number(), v.integer()), 0)
...
export const vAccountDetailsResponse = v.object({
    avatar: v.optional(v.object({
        gravatar: v.optional(v.object({
            hash: v.optional(v.string())
        })),
        tmdb: v.optional(v.object({
            avatar_path: v.optional(v.string())
        }))
    })),
    id: v.optional(v.pipe(v.number(), v.integer()), 0),
...
export const vCertificationMovieListResponse = v.object({
    certifications: v.optional(v.object({
        AU: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        BG: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        BR: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        CA: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        'CA-QC': v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        DE: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        DK: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        ES: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        FI: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        FR: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        GB: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        HU: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        IN: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        IT: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        LT: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        MY: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        NL: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        NO: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        NZ: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        PH: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        PT: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        RU: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        SE: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        US: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        KR: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        SK: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        TH: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        MX: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        ID: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        TR: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        AR: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        GR: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        TW: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        ZA: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        SG: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        IE: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        PR: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        JP: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        VI: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        CH: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        IL: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        HK: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        MO: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        LV: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        LU: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        })))
...
export const vCertificationsTvListResponse = v.object({
    certifications: v.optional(v.object({
        ...
        PL: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
        MA: v.optional(v.array(v.object({
            certification: v.optional(v.string()),
            meaning: v.optional(v.string()),
            order: v.optional(v.pipe(v.number(), v.integer()), 0)
        }))),
...
export const vWatchProvidersMovieListResponse = v.object({
    results: v.optional(v.array(v.object({
        display_priorities: v.optional(v.object({
 ...
 * 200
 */
export const vConfigurationCountriesResponse = v.array(v.object({
    iso_3166_1: v.optional(v.string()),
    english_name: v.optional(v.string()),
    native_name: v.optional(v.string())
}));
 ...
 * 200
 */
export const vConfigurationJobsResponse = v.array(v.object({
    department: v.optional(v.string()),
 ...
 * 200
 */
export const vConfigurationLanguagesResponse = v.array(v.object({
    iso_639_1: v.optional(v.string()),
    english_name: v.optional(v.string()),
    name: v.optional(v.string())
}));
 ...
 * 200
 */
export const vConfigurationTimezonesResponse = v.array(v.object({
    iso_3166_1: v.optional(v.string()),
